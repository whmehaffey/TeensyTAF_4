...
def updateTemplate():
    ...
    loadfilename = (QtGui.QFileDialog.getOpenFileName(ui,'Open Template File',GlobalVars.DirPath,'*.TMPLT'))
    GlobalVars.DirPath = QtCore.QFileInfo(loadfilename).path();
...
def loadConfig_ButtonPressed():
    ...
    loadfilename = (QtGui.QFileDialog.getOpenFileName(ui,'Open Config File', GlobalVars.DirPath,'*.TAFcfg'))
    GlobalVars.DirPath = QtCore.QFileInfo(loadfilename).path();
...
def saveConfig_ButtonPressed():
    import GlobalVars
    savefilename = (QtGui.QFileDialog.getSaveFileName(ui,'Save Config File', GlobalVars.DirPath, '.TAFcfg'))
    GlobalVars.DirPath = QtCore.QFileInfo(savefilename).path();
...
def SaveFileButtonPressed():
    ...
    GlobalVars.SavePath = QtGui.QFileDialog.getSaveFileName(ui,'Save File', GlobalVars.DirPath, '')
...
def HitAboveButtonPressed():
    ...
    print('SET FREQDIR ' + str(int(GlobalVars.HitDIR)) + ';'))
